...
const AtriaMaker = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Atria", Default: Dark });
export default AtriaMaker;

...
const BaiduAiCloud = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Baidu AI Cloud", Default: Dark });
export default BaiduAiCloud;

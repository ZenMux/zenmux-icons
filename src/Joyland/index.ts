...
const Joyland = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Joyland", Default: Dark });
export default Joyland;

...
const AgnesAi = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Agnes AI", Default: Dark });
export default AgnesAi;

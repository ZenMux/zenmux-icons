...
const DeepseekProvider = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "DeepSeek", Default: Dark });

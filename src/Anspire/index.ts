...
const Anspire = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Anspire", Default: Dark });
export default Anspire;

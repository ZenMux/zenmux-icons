...
const LivekitCombineDark = ({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 206.46991342554074 48" fill="none" width={typeof size === 'number' ? size * 4.301456529698766 : 'calc(' + size + ' * 4.301456529698766)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g fill="none" transform="translate(0 0) scale(1.199063231850117) translate(-3.984375 -3.984375)"><g transform="translate(-361 -1381)"><g id={instanceId + "-livekit-combine-dark__livekit-dark-symbol__Name=LiveKit, Type=Dark, Variant=Default"}><g id={instanceId + "-livekit-combine-dark__livekit-dark-symbol__LiveKit / Icon_2"}><path id={instanceId + "-livekit-combine-dark__livekit-dark-symbol__LiveKit / path 01_2"} fillRule="evenodd" clipRule="evenodd" d="M389 1401H381V1409H389V1401ZM397 1393H389V1401H397V1393ZM397 1409H389V1417H397V1409ZM405 1385H397V1393H405V1385ZM405 1417H397V1425H405V1417Z" fill="white" style={{
              fill: "white",
              fillOpacity: 1

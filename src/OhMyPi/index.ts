...
const OhMyPi = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Oh My Pi", Default: Dark });
export default OhMyPi;

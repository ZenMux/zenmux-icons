...
const Rikkahub = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "RikkaHub", Default: Dark });
export default Rikkahub;

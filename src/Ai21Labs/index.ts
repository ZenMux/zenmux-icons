...
const Ai21Labs = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "AI21 Labs", Default: Dark });
export default Ai21Labs;

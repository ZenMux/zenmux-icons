...
const MistralProviderLight = ({
  size = '1em',
  ...props
}: IconProps, ref: Ref<SVGSVGElement>) => {
  const instanceId = useId();
  return <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" width={size} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g clipPath={'url(#' + instanceId + "-mistral-provider-light__clip0_22_4389)"}><path d="M6.85596 6.79999H13.714V13.656H6.85596V6.79999ZM34.284 6.79999H41.144V13.656H34.284V6.79999Z" fill="white" style={{
        fill: "white",
        fillOpacity: 1
        ...
        fill: "white",
        fillOpacity: 1
      }} /></g><defs><clipPath id={instanceId + "-mistral-provider-light__clip0_22_4389"}><rect width={48} height={48} fill="white" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath></defs></svg>;
};
const ForwardRef = forwardRef(MistralProviderLight);

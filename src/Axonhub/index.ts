...
const Axonhub = Object.assign(Mono, { Color, ColorLight, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "AxonHub", Default: Dark });
export default Axonhub;

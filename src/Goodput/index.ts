...
const Goodput = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "GoodPut", Default: Dark });
export default Goodput;

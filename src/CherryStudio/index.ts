...
const CherryStudio = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Cherry Studio", Default: Dark });

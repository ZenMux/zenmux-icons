...
const KwaikatText = ({
  ...
  return <svg viewBox="0 0 89 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" width={typeof size === 'number' ? size * 3.7083333333333335 : 'calc(' + size + ' * 3.7083333333333335)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g clipPath={'url(#' + instanceId + "-kwaikat-text__clip0_22_2209)"}><path d="M6.09825 11.8548L12.1796 21H8.79714L3.95778 13.9314L3.03891 14.8343V21H0V5.56927H3.03891V10.7043L8.04873 5.63497L8.11531 5.56838H12.1841L6.09825 11.8548Z" fill="currentColor" style={{
        fill: "currentColor",
        fillOpacity: 1
        ...
        fill: "currentColor",
        fillOpacity: 1
      }} /></g><defs><clipPath id={instanceId + "-kwaikat-text__clip0_22_2209"}><rect width={88.5751} height={24} fill="#fff" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath></defs></svg>;
};

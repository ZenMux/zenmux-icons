...
const Kwaikat = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "KwaiKAT", Default: Dark });
export default Kwaikat;

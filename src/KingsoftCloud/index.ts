...
const KingsoftCloud = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Kingsoft Cloud", Default: Dark });
export default KingsoftCloud;

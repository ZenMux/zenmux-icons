...
const DeepCogito = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Deep Cogito", Default: Dark });
export default DeepCogito;

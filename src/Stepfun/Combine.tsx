...
const StepfunCombine = ({
  size = '1em',
  ...props
}: IconProps, ref: Ref<SVGSVGElement>) => {
  const instanceId = useId();
  return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 187.33437499999997 48" fill="none" color="currentColor" width={typeof size === 'number' ? size * 3.902799479166666 : 'calc(' + size + ' * 3.902799479166666)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g fill="none" transform="translate(0 0) scale(1) translate(0 0)"><g clipPath={'url(#' + instanceId + "-stepfun-combine__stepfun-dark-symbol__clip0_7_343)"}><g clipPath={'url(#' + instanceId + "-stepfun-combine__stepfun-dark-symbol__clip1_7_343)"}><path d="M23.9993 0.000549316C10.7468 0.000549316 0.000488281 10.7469 0.000488281 23.9994C0.000488281 37.2519 10.7468 47.9983 23.9993 47.9983C37.2519 47.9983 47.9982 37.2519 47.9982 23.9994C47.9982 10.7469 37.2575 0.000549316 23.9993 0.000549316ZM17.5493 39.2296H8.77488V30.4552H17.5493V39.2296ZM28.3865 39.2296H19.6122V30.4552H28.3865V39.2296ZM28.3865 28.3866H19.6122V19.6122H28.3865V28.3866ZM28.3865 17.5493H19.6122V8.77494H28.3865V17.5493ZM39.2295 17.5493H30.4551V8.77494H39.2295V17.5493Z" fill="currentColor" style={{
            fill: "currentColor",
            fillOpacity: 1
          }} /></g></g><defs><clipPath id={instanceId + "-stepfun-combine__stepfun-dark-symbol__clip0_7_343"}><rect width={48} height={48} fill="#fff" style={{
            fill: "white",
            fillOpacity: 1
          }} /></clipPath><clipPath id={instanceId + "-stepfun-combine__stepfun-dark-symbol__clip1_7_343"}><rect width={48} height={48} fill="#fff" style={{
            fill: "white",
            fillOpacity: 1
          }} /></clipPath></defs></g><g fill="none" transform="translate(60 7.200000000000003) scale(1.8666666666666663) translate(0 -3)"><g clipPath={'url(#' + instanceId + "-stepfun-combine__stepfun-dark-text__clip0_7_362)"}><g clipPath={'url(#' + instanceId + "-stepfun-combine__stepfun-dark-text__clip1_7_362)"}><path fillRule="evenodd" clipRule="evenodd" d="M33.3428 7.01074C34.5857 7.01077 35.8115 7.52551 36.7051 8.42578C37.6692 9.39658 38.2001 10.7198 38.2002 12.2549C38.2002 13.79 37.7001 15.104 36.7529 16.0547C35.8661 16.9449 34.6563 17.4355 33.3428 17.4355C32.2175 17.4355 31.0986 17.0361 30.3428 16.3711V21H28.1455V7.26953H30.3428V8.07617C31.0987 7.40765 32.2174 7.01074 33.3428 7.01074ZM33.3262 8.93945C31.8783 8.93945 30.3391 10.0916 30.3389 12.2246C30.3389 14.3579 31.8782 15.5107 33.3262 15.5107C34.9352 15.5106 36.0166 14.1898 36.0166 12.2246C36.0164 10.2597 34.9351 8.93961 33.3262 8.93945Z" fill="currentColor" style={{
            fill: "currentColor",
            fillOpacity: 1
            ...
            fill: "currentColor",
            fillOpacity: 1
          }} /></g></g><defs><clipPath id={instanceId + "-stepfun-combine__stepfun-dark-text__clip0_7_362"}><rect width={68.207} height={24} fill="#fff" style={{
            fill: "white",
            fillOpacity: 1
          }} /></clipPath><clipPath id={instanceId + "-stepfun-combine__stepfun-dark-text__clip1_7_362"}><rect width={68.207} height={24} fill="#fff" style={{
            fill: "white",
            fillOpacity: 1
          }} /></clipPath></defs></g></svg>;
};
const ForwardRef = forwardRef(StepfunCombine);

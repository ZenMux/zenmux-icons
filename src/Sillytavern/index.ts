...
const Sillytavern = Object.assign(Mono, { Color, Dark, Light, ColorLight, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "SillyTavern", Default: Dark });

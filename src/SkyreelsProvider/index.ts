...
const SkyreelsProvider = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "SkyReels", Default: Dark });
export default SkyreelsProvider;

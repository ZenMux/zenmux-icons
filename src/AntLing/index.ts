...
const AntLing = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Ant Ling", Default: Dark });
export default AntLing;

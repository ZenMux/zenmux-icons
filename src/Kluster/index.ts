...
const Kluster = Object.assign(Mono, { Color, Dark, Light, ColorLight, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Kluster", Default: Dark });

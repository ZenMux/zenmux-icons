...
const OpencodeCombineLight = ({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 264.3965712822014 48" fill="none" width={typeof size === 'number' ? size * 5.50826190171253 : 'calc(' + size + ' * 5.50826190171253)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g fill="none" color="#ffffff" transform="translate(0 0) scale(1.199063231850117) translate(-7.9921875 -3.984375)"><g transform="translate(-361 -2877)"><g id={instanceId + "-opencode-combine-light__opencode-light-symbol__Name=opencode, Type=Dark, Variant=Default"}><g id={instanceId + "-opencode-combine-light__opencode-light-symbol__opencode / Icon_2"}><path id={instanceId + "-opencode-combine-light__opencode-light-symbol__opencode / path 01_2"} fillRule="evenodd" clipRule="evenodd" d="M393 2889H377V2913H393V2889ZM401 2921H369V2881H401V2921Z" fill="#000000" style={{
              fill: "#000000",
              fillOpacity: 1
            }} /></g></g></g></g><g fill="none" transform="translate(50.38875878220141 4.799999999999997) scale(1.6000000000000003) translate(-2.12255859375 0)"><g transform="translate(-21 -5653) scale(1.390625)"><g id={instanceId + "-opencode-combine-light__opencode-light-text__Name=opencode, Type=Color, Language=Default"}><g id={instanceId + "-opencode-combine-light__opencode-light-text__opencode / Wordmark"} clipPath={'url(#' + instanceId + "-opencode-combine-light__opencode-light-text__clip58_1_3407)"}><path id={instanceId + "-opencode-combine-light__opencode-light-text__opencode / path 01"} fillRule="evenodd" clipRule="evenodd" d="M24.0387 4077.41H19.1064V4072.48H24.038L24.0387 4077.41Z" fill="black" fillOpacity={0.25} style={{
              fill: "black",
              fillOpacity: 0.25

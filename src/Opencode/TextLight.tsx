...
const OpencodeTextLight = ({
  ...
  return <svg viewBox="0 0 101 24" fill="none" xmlns="http://www.w3.org/2000/svg" width={typeof size === 'number' ? size * 4.208333333333333 : 'calc(' + size + ' * 4.208333333333333)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g clipPath={'url(#' + instanceId + "-opencode-text-light__clip0_31_97)"}><g clipPath={'url(#' + instanceId + "-opencode-text-light__clip1_31_97)"}><path fillRule="evenodd" clipRule="evenodd" d="M7.71505 15.8573H2.5708V10.7145H7.7143L7.71505 15.8573Z" fill="white" fillOpacity={0.25} style={{
          fill: "white",
          fillOpacity: 0.25
          ...
          fill: "white",
          fillOpacity: 1
        }} /></g></g><defs><clipPath id={instanceId + "-opencode-text-light__clip0_31_97"}><rect width={100.286} height={24} fill="white" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath><clipPath id={instanceId + "-opencode-text-light__clip1_31_97"}><rect width={100.286} height={24} fill="white" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath></defs></svg>;
};

...
const VectorizerAi = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Vectorizer.AI", Default: Dark });
export default VectorizerAi;

...
const Celestoai = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "CelestoAI", Default: Dark });
export default Celestoai;

...
const Cloudsway = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "Cloudsway", Default: Dark });
export default Cloudsway;

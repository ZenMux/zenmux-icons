...
const Openhuman = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "OpenHuman", Default: Dark });
export default Openhuman;

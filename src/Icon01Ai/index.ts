...
const Icon01Ai = Object.assign(Mono, { Color, Dark, Light, ColorLight, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "01.AI", Default: Dark });
export default Icon01Ai;

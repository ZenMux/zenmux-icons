...
const InceptionLabs = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Inception Labs", Default: Dark });

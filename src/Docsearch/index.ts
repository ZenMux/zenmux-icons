...
const Docsearch = Object.assign(Mono, { Color, Dark, Light, ColorLight, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "DocSearch", Default: Dark });

...
const Apertis = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Apertis", Default: Dark });
export default Apertis;

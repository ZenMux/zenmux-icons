...
const BilibiliIndex = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "Bilibili Index", Default: Dark });
export default BilibiliIndex;

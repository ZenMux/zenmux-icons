...
const StepfunProvider = Object.assign(Mono, { Color, Dark, Light, TextDark, TextLight, Text, CombineDark, CombineLight, Combine, Avatar, title: "StepFun", Default: Dark });
export default StepfunProvider;

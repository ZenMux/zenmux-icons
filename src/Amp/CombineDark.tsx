...
const AmpCombineDark = ({
  ...
  return <svg viewBox="0 0 75 24" fill="none" xmlns="http://www.w3.org/2000/svg" width={typeof size === 'number' ? size * 3.125 : 'calc(' + size + ' * 3.125)'} height={size} aria-hidden="true" focusable="false" ref={ref} {...props}><g id={instanceId + "-amp-combine-dark__Name=Amp, Type=Dark, Variant=Combine"}><g id={instanceId + "-amp-combine-dark__Amp / Combination"} clipPath={'url(#' + instanceId + "-amp-combine-dark__clip0_449_12150)"}><g id={instanceId + "-amp-combine-dark__Frame"} clipPath={'url(#' + instanceId + "-amp-combine-dark__clip1_449_12150)"}><path id={instanceId + "-amp-combine-dark__Amp / path 01"} fillRule="evenodd" clipRule="evenodd" d="M15.0871 23.18L12.0301 24L9.93307 16.177L4.19507 21.915L1.94407 19.664L7.66207 13.945L-0.106934 11.863L0.713066 8.806L12.0071 11.886L15.0871 23.18Z" fill="white" style={{
            fill: "white",
            fillOpacity: 1
          }} /><path id={instanceId + "-amp-combine-dark__Amp / path 02"} fillRule="evenodd" clipRule="evenodd" d="M19.505 18.762L16.448 19.582L13.884 10.009L4.31201 7.445L5.13101 4.388L16.426 7.467L19.506 18.762H19.505Z" fill="white" style={{
            fill: "white",
            fillOpacity: 1
          }} /><path id={instanceId + "-amp-combine-dark__Amp / path 03"} fillRule="evenodd" clipRule="evenodd" d="M23.8932 14.374L20.8362 15.194L18.2712 5.622L8.7002 3.057L9.5202 0L20.8152 3.08L23.8932 14.374Z" fill="white" style={{
            fill: "white",
            fillOpacity: 1
            ...
            fill: "white",
            fillOpacity: 1
          }} /></g></g></g><defs><clipPath id={instanceId + "-amp-combine-dark__clip0_449_12150"}><rect width={74.4} height={24} fill="white" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath><clipPath id={instanceId + "-amp-combine-dark__clip1_449_12150"}><rect width={24} height={24} fill="white" style={{
          fill: "white",
          fillOpacity: 1
        }} /></clipPath><clipPath id={instanceId + "-amp-combine-dark__clip2_449_12150"}><rect width={43.2} height={19.2} fill="white" style={{
          fill: "white",
          fillOpacity: 1

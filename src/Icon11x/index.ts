...
const Icon11x = Object.assign(Mono, { Color, Dark, Light, TextLight, TextDark, Text, CombineDark, CombineLight, Combine, Avatar, title: "11x", Default: Dark });
export default Icon11x;
